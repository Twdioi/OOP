...
QT_MOC_LITERAL(1, 8, 13), // "s_transmitter"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9), // "newWindow"
QT_MOC_LITERAL(4, 33, 1) // "n"

    },
    "MyClass\0s_transmitter\0\0newWindow\0n"
};
...
void MyClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->s_transmitter();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: _t->newWindow((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef int (MyClass::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyClass::s_transmitter)) {
                *result = 0;
                return;
            }
        }
